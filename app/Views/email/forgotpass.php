...
<head>
    <title>Elixa Digitals Forgot Password</title>
                    ...
                    <tr>
                        <td align="center" valign="top" style="padding: 40px 10px 40px 10px;">
                            <a href="<?=site_url()?>" target="_blank">
                                <img alt="Logo" src="<?=site_url('assets/images/logo.png')?>" width="100" height="100" style="display: block;  font-family: 'Lato', Helvetica, Arial, sans-serif; color: #ffffff; font-size: 18px;" border="0">
                            </a>
                        </td>
                    </tr>
                </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="480">
                    ...
                    <tr>
                        <td bgcolor="#f4f4f4" align="left" style="padding: 0px 30px 30px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 18px;">
                            <p style="margin: 0;">You received this email because you requested a password reset. If you did not, please contact +2348086172924</p>
                        </td>
                    </tr>
                </table>
            </td>
